...
public interface AuthApi {
    ...
    RedirectView ssoAuthorize(@RequestParam(value = "redirect", required = false) String redirect);

    @ApiOperation("单点登录")
    @GetMapping("/sso/login/code/{code}")
    Object loginCode(@PathVariable("code") String code, @RequestParam(value = "redirect", required = false)  String redirect);
