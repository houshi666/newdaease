...
public class ShiroServiceImpl implements ShiroService {
    ...
    public Map<String, String> loadFilterChainDefinitionMap() {
        ...
        filterChainDefinitionMap.put("/api/auth/sso/authorize", ANON);
        filterChainDefinitionMap.put("/api/auth/sso/login/code/**", ANON);
        filterChainDefinitionMap.put("/sso.html", ANON);
        ...
        filterChainDefinitionMap.put("/panel/group/getPanelListByTenantId/**", ANON);
        filterChainDefinitionMap.put("/panel/group/getVisitToken", ANON);
