...
public class PanelLinkService {
    ...
    public String getShortUrl(String resourceId, String token) {
        PanelLinkMappingExample example = new PanelLinkMappingExample();
        example.createCriteria().andResourceIdEqualTo(resourceId).andUserIdEqualTo(AuthUtils.getUser().getUserId());
        List<PanelLinkMapping> mappings = panelLinkMappingMapper.selectByExample(example);
        ...
        // 更新仪表盘表的缩略图字段
        String picturePath = pictureWebPath + contextPath + SHORT_URL_PREFIX + (StringUtils.isBlank(uuid) ? mapping.getId() : uuid);
        webService.generator(picturePath, 5, resourceId, token);
...
//    "L%2Bv5SNEaggpZ5luf0KFjtA0umcdESjAPRPLN5%2BAl9Z7hKCTr%2BRLx%2FxyVrLAz0Z2z0X%2FSSSjbeYscVEXdsyq%2FkA"
    public static void main(String[] args) throws Exception {
        String str = decryptParam("L%2Bv5SNEaggpZ5luf0KFjtA0umcdESjAPRPLN5%2BAl9Z7hKCTr%2BRLx%2FxyVrLAz0Z2z0X%2FSSSjbeYscVEXdsyq%2FkA");
