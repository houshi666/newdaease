...
public class IndexController {
    ...
    @GetMapping("/link/{index}/{visitCode}")
    public void link(@PathVariable(value = "index", required = true) String index, @PathVariable(value = "visitCode", required = true) String visitCode) {
        String url;
