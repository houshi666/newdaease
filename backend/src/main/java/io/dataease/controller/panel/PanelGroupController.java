...
import io.dataease.dto.panel.PanelGroupExtShowDto;
...
public class PanelGroupController {
    ...
    @ApiOperation("根据租户id查询看板列表")
    @GetMapping("/getPanelListByTenantId/{tenantId}")
    public List<PanelGroupExtShowDto> getPanelListByTenantId(@PathVariable String tenantId) {
        return panelGroupService.getPanelListByTenantId(tenantId);
    }

    @GetMapping("/getVisitToken")
    public String getVisitToken() {
        HttpServletRequest request = ServletUtils.request();
        String visitToken = request.getHeader("Authorization");
        return visitToken;
    }
