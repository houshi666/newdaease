...
public class SysUserController {
    ...
    @ApiIgnore
    @PostMapping("/getTenantUserList")
    public List<SysUserGridResponse> getTenantUserList(@RequestBody BaseGridRequest request) {
        KeyGridRequest keyGridRequest = BeanUtils.copyBean(new KeyGridRequest(), request);
        return sysUserService.queryForTenant(keyGridRequest);
    }
